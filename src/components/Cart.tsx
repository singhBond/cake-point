...
export const Cart = () => {
  ...
  return (
    <main>
      ...
      >
        <div className="relative bg-pink-700 hover:bg-pink-900 text-white p-4 rounded-full shadow-2xl border-2 border-white transition-all group-hover:scale-110">
