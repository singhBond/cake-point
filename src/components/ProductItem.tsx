  ...
  return (
    <>
      ...
      <div
        ...
        className="overflow-hidden  rounded-2xl bg-pink-100 shadow-md shadow-orange-200 hover:shadow-xl transition-all cursor-pointer border border-gray-100 hover:border-orange-300 relative group"
      >
      ...
      <Dialog open={open} onOpenChange={handleOpenChange}>
        <DialogContent className="max-w-full w-full h-full md:max-w-2xl md:h-auto md:max-h-[85vh] rounded-none md:rounded-2xl p-0 overflow-hidden flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto px-3 py-1 bg-pink-50">
            <div className="flex flex-col md:flex-row gap-3">
              ...
              <div className="flex-1 flex flex-col justify-between px-2 md:px-0">
                <div className="space-y-4">
                  {product.description && (
                    <div className="relative bg-pink-100 border-l-4 border-pink-400 rounded-lg p-3">
                      <span className="absolute -top-2 -left-1 text-5xl text-pink-300 font-serif">
                        “
                      </span>
                      <p className="italic text-gray-700  leading-relaxed font-serif">
                        <DescriptionWithReadMore text={product.description} />
                      </p>
                      <span className="absolute -bottom-7 right-2 text-5xl text-pink-300 font-serif">
                        ”
                      </span>
                    </div>
                  )}
                      ...
                      {product.quantities.map((qty, index) => (
                        <Button
                          ...
                          className={`h-10 w-18 text-sm font-medium rounded-xl ${
                            selectedQuantityIndex === index
                              ? "bg-pink-500 hover:bg-pink-800 text-white shadow-lg shadow-slate-400"
                              : "border-gray-300"
                          }`}
                          onClick={() => {
                  ...
                  <Button
                    className="w-full bg-pink-500 hover:bg-pink-600 text-white font-bold py-6 text-lg mt-1 mb-3 rounded-xl shadow-lg"
                    onClick={addToCart}
                  >
